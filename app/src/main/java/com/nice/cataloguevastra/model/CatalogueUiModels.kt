...
data class CatalogueUiState(
    val catalogueThemes: List<CatalogueThemeUiModel> = emptyList(),
    val catalogueForOptions: List<String>,
    val selectedCatalogueFor: String,
    val garmentSubcategories: List<GarmentSubcategoryUiModel> = emptyList(),
...
data class GarmentSubcategoryUiModel(
    val id: String,
    val themeFor: String,
    val name: String,
